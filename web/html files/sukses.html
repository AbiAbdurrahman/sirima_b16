  ...
  <body>
        ...
        <div class="container" id="input-form">
  			...
  			<form action="" method="POST" role="form">
  				<legend class="text-center">PENDAFTARAN SUKSES</legend><br>
          <h5 class="text-center">Selamat pembayaran berhasil dilakukan</h5>
          ...
          <div class="form-group">
            <label for="usr">ID Pembayaran</label>
            <input type="text" class="form-control" id="usr" value="9876">
          </div>

          <div class="form-group">
            <label for="usr">Nomor Kartu Ujian</label>
            <input type="text" class="form-control" id="usr" value="195830284932">
          </div>
